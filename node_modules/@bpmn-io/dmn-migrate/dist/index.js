...
function is(element, type) {
  return minDash.isFunction(element.$instanceOf) && element.$instanceOf(type);
}
...
function isAny(element, types) {
  return minDash.some(types, type => is(element, type));
}
...
function getDMNElementRef(drgElement, source) {
  ...
  return Object.values(drgElement).reduce((dmnElementRef, dmnElements) => {
    if (minDash.isArray(dmnElements)) {
...
exports.TARGET_DMN_VERSION = TARGET_DMN_VERSION;
